...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getVisitors: function getVisitors() {
      ...
      axios.post('./get-data/about').then(function (response) {
        _this.data = response.data; // console.log(response);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'app',
  components: {
    Banner: _Banner__WEBPACK_IMPORTED_MODULE_0__["default"] // About, 
    // Services,
    // Products,
    // Promote,
    // Testimonial,
  ...
  mounted: function mounted() {
    ...
    axios.post('./get-data/about').then(function (response) {
      ...
      if (response.data.avatar == 'null') {
        _this2.avatar = 'images/zakir.png';
      } else {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    hire: function hire() {
      ...
      this.form.post('hireme').then(function (_ref) {
        var data = _ref.data;
        // console.log(data);
        _this3.form.name = '', _this3.form.email = '', _this3.form.budget = '', _this3.form.social = '', _this3.form.message = '';
      });
    }
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPotfolioData: function getPotfolioData(nextPageUrl) {
      var _this = this;
      ...
      axios.post(dataUrl).then(function (response) {
        ...
        if (_this.portfolioMainPage) {
          ...
          for (var i = 0; i < response.data.data.length; i++) {
            _this.portfolios.push(response.data.data[i]);
          }
        }

        _this.portfolioMainPage = false;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getServices: function getServices() {
      ...
      axios.post('get-data/services').then(function (response) {
        // console.log(response);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getProductData: function getProductData(nextPageUrl) {
      var _this = this;

      var mainURl = 'get-data/products';
      var dataUrl = nextPageUrl || mainURl;
      axios.post(dataUrl).then(function (response) {
        // console.log(response.data);
        if (_this.productMainPage) {
          _this.products = response.data.data;
          console.log(_this.products);
          console.log(_this.products.length);
        } else {
          for (var i = 0; i < response.data.data.length; i++) {
            _this.products.push(response.data.data[i]);
          }
        }

        _this.productMainPage = false;
        _this.prev_page_url = response.data.prev_page_url;
        _this.next_page_url = response.data.next_page_url;
                ...
                [
                  ...
                  _vm.currentTab == 3
                    ? _c(
                        ...
                        [
                          _c("div", { staticClass: "connect-info" }, [
                            _c("div", { staticClass: "info-item" }, [
                              _c("strong", [_vm._v("Phone")]),
                              _vm._v(" "),
                              _c("p", { staticClass: "mb-0" }, [
                                _vm._v(_vm._s(_vm.setting.phone))
                              ])
                            ]),
                            _vm._v(" "),
                            _c("div", { staticClass: "info-item" }, [
                              ...
                              _vm._v(" "),
                              _c("p", { staticClass: "mb-0" }, [
                                _vm._v(_vm._s(_vm.setting.email))
                              ])
                            ]),
                            _vm._v(" "),
                            _c("div", { staticClass: "info-item" }, [
                              ...
                              _vm._v(" "),
                              _c("p", { staticClass: "mb-0" }, [
                                _vm._v(_vm._s(_vm.setting.address))
                              ])
                            ]),
                            _vm._v(" "),
                            _c("div", { staticClass: "info-item" }, [
                              _c("ul", { staticClass: "find-me" }, [
                                _vm.setting.facebook
                                  ? _c("li", [
                                      _c(
                                        "a",
                                        {
                                          attrs: {
                                            href: _vm.setting.facebook,
                                            target: "_blank"
                                          }
                                        },
                                        [
                                  ...
                                  : _vm._e(),
                                _vm._v(" "),
                                _vm.setting.linkedin
                                  ? _c("li", [
                                      _c(
                                        "a",
                                        {
                                          attrs: {
                                            href: _vm.setting.linkedin,
                                            target: "_blank"
                                          }
                                        },
                                        [
                                ...
                                _vm.setting.stack
                                  ? _c("li", [
                                      _c(
                                        ...
                                        {
                                          attrs: {
                                            href: _vm.setting.stack,
                                            target: "_blank"
                                          }
                                        },
                                        [
                                          _c("i", {
                                            staticClass: "fab fa-stack-overflow"
                                          })
                                        ]
                                      )
                                    ])
                                ...
                                _vm.setting.quora
                                  ? _c("li", [
                                      _c(
                                        ...
                                        {
                                          attrs: {
                                            href: _vm.setting.quora,
                                            target: "_blank"
                                          }
                                        },
                                        [
                                          _c("i", {
                                            staticClass: "fab fa-quora"
                                          })
                                        ]
                                      )
                                    ])
        ...
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-12" }, [
            _c("div", { staticClass: "contact-details d-flex" }, [
              _c("div", { staticClass: "details-left connect-info" }, [
                _c("div", { staticClass: "info-item" }, [
                  _c("strong", [_vm._v("Phone")]),
                  _vm._v(" "),
                  _c("p", { staticClass: "mb-0" }, [
            ...
            _c("ul", [
              _vm.setting.facebook
                ? _c("li", [
                    _c(
                      "a",
                      {
                        attrs: { href: _vm.setting.facebook, target: "_blank" }
                      },
                      [_vm._v(" Facebook  ")]
                    )
                  ])
              ...
              _vm.setting.linkedin
                ? _c("li", [
                    _c(
                      "a",
                      {
                        attrs: { href: _vm.setting.linkedin, target: "_blank" }
                      },
                      [_vm._v(" Linkedin ")]
                    )
                  ])
              ...
              _vm.setting.github
                ? _c("li", [
                    _c(
                      "a",
                      { attrs: { href: _vm.setting.github, target: "_blank" } },
                      [_vm._v(" Github ")]
                    )
                  ])
                : _vm._e(),
              ...
              _vm.setting.stack
                ? _c("li", [
                    _c(
                      "a",
                      { attrs: { href: _vm.setting.stack, target: "_blank" } },
              ...
              _vm.setting.quora
                ? _c("li", [
                    _c(
                      "a",
                      { attrs: { href: _vm.setting.quora, target: "_blank" } },
                      [_vm._v(" Quora  ")]
                    )
                  ])
                : _vm._e()
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-12 col-sm-6 col-md-3 item" }, [
      _c("h5", [_vm._v("Resource")]),
      _vm._v(" "),
      _c("ul", [
        _c("li", [_c("a", { attrs: { href: "#" } }, [_vm._v("Blog")])]),
        _vm._v(" "),
        _c("li", [_c("a", { attrs: { href: "#" } }, [_vm._v("My Resource")])]),
        _vm._v(" "),
        _c("li", [_c("a", { attrs: { href: "#" } }, [_vm._v("Useful Links")])]),
        _vm._v(" "),
        _c("li", [_c("a", { attrs: { href: "#" } }, [_vm._v("Free Tools")])])
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "col-12 col-sm-6 col-md-3 item" }, [
      ...
      _c("ul", [
        ...
        _vm._v(" "),
        _c("li", [
          _c("a", { attrs: { href: "#" } }, [_vm._v("Freelancer Profile")])
        ])
      ])
    ])
  },
                    ...
                    [
                        ...
                        _c("ul", [
                          ...
                          _vm.form.errors.has("budget")
                            ? _c("li", [
                                _vm._v(
                                  " " +
                                    _vm._s(_vm.form.errors.get("budget")) +
                                    " "
                                )
                              ])
                            : _vm._e(),
                          _vm._v(" "),
                          _vm.form.errors.has("social")
                            ? _c("li", [
                                _vm._v(
                                  " " +
                                    _vm._s(_vm.form.errors.get("social")) +
                                    " "
                                )
                              ])
                            : _vm._e(),
                      ...
                      _c("div", { staticClass: "form-group" }, [
                        ...
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.form.social,
                              expression: "form.social"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: {
                          ...
                          domProps: { value: _vm.form.social },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                              }
                              _vm.$set(_vm.form, "social", $event.target.value)
                            }
                          }
                        })
                      ]),
    ...
    _c(
      ...
      [
        _c("div", { staticClass: "container" }, [
          ...
          _c(
            "div",
            { staticClass: "row portfolio-list" },
            _vm._l(_vm.portfolios, function(portfolio) {
              return _c(
                "div",
                { key: portfolio.id, staticClass: "col-12 col-md-6 col-lg-4" },
                [
                  _c("div", { staticClass: "item" }, [
                    _c("div", { staticClass: "preview" }, [
                      _c("img", {
                        staticClass: "img-fluid",
                        attrs: { src: portfolio.image, alt: "" }
                      })
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "details" }, [
                      _c("small", [_vm._v(_vm._s(portfolio.category_name))]),
                      _vm._v(" "),
                      _c("h6", [
                        _vm._v(
                ...
                : false)
                  ? _c(
                      "button",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.getPotfolioData(_vm.next_page_url)
                          }
                        }
                      },
                      [_vm._v("Load More")]
        ...
        _c("div", { staticClass: "container" }, [
          _c("div", { staticClass: "row services" }, [
            ...
            _c("div", { staticClass: "col-12 col-md-8 col-lg-7" }, [
              _c(
                "div",
                { staticClass: "d-flex flex-wrap my-services" },
                _vm._l(_vm.services, function(service) {
                  return _c(
                    "div",
                    { key: service.id, staticClass: "item item1" },
                    [
                      _c("div", { staticClass: "item-info" }, [
                        _c("div", { staticClass: "icon bg-white" }, [
                          _c("img", {
                            staticClass: "img-fluid",
                            attrs: { src: service.icon, alt: "" }
                          })
                        ]),
                        _vm._v(" "),
    ...
    return _c(
      ...
      [
        ...
        _c("div", { staticClass: "row counter" }, [
          _c("div", { staticClass: "col-lg-6 col-md-12 col-sm-6 col-6" }, [
            _c("div", { staticClass: "item" }, [
              _c("h4", [_vm._v("3+")]),
              _vm._v(" "),
          ...
          _c("div", { staticClass: "buttons text-center" }, [
            ...
            : false)
              ? _c(
                  "button",
                  {
                    attrs: { href: "#", disabled: !_vm.loadMore },
                    on: {
                      click: function($event) {
                        return _vm.getProductData(_vm.next_page_url)
                      }
                    }
                  },
                  [_vm._v("Load More")]
    ...
    _c("div", { staticClass: "info" }, [
      ...
      _c("div", { staticClass: "info-footer" }, [
        _c("div", { staticClass: "category" }, [
          _c("p", [_vm._v(_vm._s(_vm.product.category_name))])
        ]),
        _vm._v(" "),
        _vm._m(0)
      ])
...
window.axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"); // Vue.use(axios)
...
module.exports = "/images/logo.svg?8ee4d3e95bce129c7fca21b9f2a1923b";
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    path: '/*',
    component: _components_404__WEBPACK_IMPORTED_MODULE_9__["default"]
  }]
});
...
__webpack_require__(/*! D:\Personal\portfolio-laravue\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\Personal\portfolio-laravue\resources\sass\app.scss */"./resources/sass/app.scss");
