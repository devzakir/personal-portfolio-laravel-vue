            ...
            <div id="sidebar" class="sidebar sidebar-with-footer">
                ...
                <div class="sidebar-scrollbar">
                    ...
                    <ul class="nav sidebar-inner" id="sidebar-menu">
                        ...
                        <li class="has-sub">
                            <a class="sidenav-item-link" href="{{ route('rating.index') }}">
                                <i class="mdi mdi-view-dashboard-outline"></i>
                                <span class="nav-text">Rating</span>
                            </a>
                        </li>
                        <li class="has-sub">
                            <a class="sidenav-item-link" href="{{ route('hire.index') }}">
                                <i class="mdi mdi-view-dashboard-outline"></i>
                ...
                <hr class="separator" />
                <div class="sidebar-footer text-center" style="padding: 10px 0px 30px;">
